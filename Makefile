...
export THIRD_PARTY_INC_DIRS = -I/usr/local/include $(shell pkg-config --cflags cairo)
export THIRD_PARTY_LIB_DIRS = -L/usr/local/lib
export BOOST_LIBS = 
export THIRD_PARTY_LIBS= ${BOOST_LIBS} -lpoppler-glib -lpoppler -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lcairo
